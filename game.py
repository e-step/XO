...
tk.Label(root, text="Tic Tac Toe", font=('Times New Roman', 25)).pack()
status_label = tk.Label(root, text="X's turn", font=('Comic Sans MS', 15), bg='pink', fg='snow')
...
play_again_button = tk.Button(root, text='Play again', font=('Corbel', 15), bg='lavender', command=play_again)
...
class XOPoint:
    ...
    def set(self):
        global current_chr
        if not self.value:
            self.button.configure(text=current_chr, bg='white', fg='black')
